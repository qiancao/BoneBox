# -*- coding: utf-8 -*-
# This is the original hdfdict by SiggiGue, retrieved 20220622 from https://github.com/SiggiGue/hdfdict/blob/master/hdfdict/hdfdict.py
# Did not include this the conda recipe because the pip package interferes with conda-pack
#
import h5py
import yaml
