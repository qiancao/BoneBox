...
if __name__ == "__main__":
    ...
    img = axs[0].imshow(np.mean(r2Test,axis=2))
    axs[0].set_xlabel("Resolution")
    axs[0].set_ylabel("Noise Level")
    axs[0].set_title("r2 mean")
    
    img = axs[1].imshow(np.std(r2Test,axis=2),cmap="inferno")
    axs[1].set_xlabel("Resolution")
    axs[1].set_ylabel("Noise Level")
    axs[1].set_title("r2 std")
    
    # fig.colorbar(img, cax=axs[0], orientation='vertical')
