...
if __name__ == "__main__":
    ...
    # output directory
    outDir = "/gpfs_projects/qian.cao/BoneBox-out/test_20220422_bin_noise_parallel/"
    ...
    # parameter space
    nScales = np.linspace(0.2,1.5,5) # change noise only
        ...
        for s, seed in enumerate(seeds):
            ...
            for rind in range(numROIs):
                ...
                if rind in ROI_VISUALIZE:
                    ...
                    plt.title(f"ROI: {rind}, Sim: {ind}")
                    plt.savefig(outDir+f"img_{rind}_{ind}.png")
                    plt.close("all")
            ...
            featuresArray[:,:,ind,s] = featureVectorArray
