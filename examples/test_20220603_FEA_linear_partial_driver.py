...
if __name__ == "__main__":
    ...
    NUMFILES = 679 # files for Segmentation Otsu (different for Segmentation L1 Otsu)

    whereami = socket.gethostname()

    if whereami in ["openHPC","didsr-gpu11"]:
        inputDir = "/gpfs_projects/qian.cao/BoneBox-out/test_20220603_FEA_meshingonly_partial_driver"
        outDir = "/gpfs_projects/qian.cao/BoneBox-out/test_20220603_FEA_linear_partial_driver"
    else: # ["betsy01.fda.gov", "bc198.fda.gov", etc]
        inputDir = "/scratch/qian.cao/BoneBox-out/test_20220603_FEA_meshingonly_partial_driver"
        outDir = "/scratch/qian.cao/BoneBox-out/test_20220603_FEA_linear_partial_driver"
