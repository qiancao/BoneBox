...
def computeFEARodPlateLinear(vertices, edges, faces,
                             ...
                             barAreas, shellThicknesses, computeFaceNeighbors = False):
    """
...
if __name__ == "__main__":
    ...
    for thick in var:
        ...
        for rr in rands:
            ...
            v = generateVoronoiSkeleton(Sxyz=(100,100,100),Nxyz = (8,8,8), randState=rr)
            vertices = v.vertices
            edges = np.array([])
            ...
            # FEA
            thicknesses0, radii0 = thick, 100e-6
