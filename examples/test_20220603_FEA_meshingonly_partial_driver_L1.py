...
if __name__ == "__main__":
    ...
    if whereami in ["openHPC","didsr-gpu11"]:
        segDir = "/gpfs_projects/qian.cao/data/Segmentations_Otsu_L1"
        outDir = "/gpfs_projects/qian.cao/BoneBox-out/test_20220603_FEA_meshingonly_partial_driver_L1"
    else: # ["betsy01.fda.gov", "bc198.fda.gov", etc]
        segDir = "/scratch/qian.cao/Segmentations_Otsu_L1"
        outDir = "/scratch/qian.cao/BoneBox-out/test_20220603_FEA_meshingonly_partial_driver_L1"
